...
- (void)viewDidLoad
{
	...
	NSArray *services = @[[CBUUID UUIDWithString:POLARH7_HRM_HEART_RATE_SERVICE_UUID], [CBUUID UUIDWithString:POLARH7_HRM_DEVICE_INFO_SERVICE_UUID], [CBUUID UUIDWithString: BLUETOOTH_STANDARD_BLOOD_PRESSURE_SERVICE_UUID]];
...
{
    NSLog(@"centralManager:(CBCentralManager *)central didConnectPeripheral");
...
{
    NSLog(@"peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error");
...
{
    NSLog(@"centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:");
...
{
     NSLog(@"peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:");
...
{
    NSLog(@"peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:");
...
{
    NSLog(@" getHeartBPMData:(CBCharacteristic *)characteristic error:(NSError *)error");
	// Get the Heart Rate Monitor BPM
...
{
    NSLog(@" getManufacturerName:(CBCharacteristic *)characteristic");
...
{
    NSLog(@" getBodyLocation:(CBCharacteristic *)characteristic");
